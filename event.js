...
function replacePlaceholders(text) {
  const replacements = {
    ...
    '<img-placeholder_얼죽삼_2024/>': '<br><span style="display: inline-block; width: auto; height: auto; box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);"><img src="images/event/2024_winter/samgyeopsal/samgyeopsal.png" alt="Additional Image" style="width: 100%; height: auto;" /></span>',
