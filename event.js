...
function replacePlaceholders(text) {
  const replacements = {
    ...
    '<img-placeholder_왔다감2024winter/>': '<br><span style="display: inline-block; width: auto; height: auto; box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);"><img src="images/event/2024_winter/washere/왔다감2024winter.png" alt="Additional Image" style="width: 100%; height: auto;" /></span>',
    ...
    '<img-placeholder_얼죽삼_2024/>': '<br><span style="display: inline-block; width: auto; height: auto; box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);"><img src="images/event/2024_winter/samgyeopsal/얼죽삼poster.png" alt="Additional Image" style="width: 100%; height: auto;" /></span>',
